...
public abstract class LoadingResourceIterable<T extends Resource> {
    ...
    public LoadingResourceIterable(JsonElement payload, PageableResourceEndpoint<T> endpoint,
